...
class Feature_Extraction_SIFT:
    ...
    def writingDescriptorToCSV(self,all_images_to_compare,titles):
            ...
            for all_images_to_compare_temp, title in zip(all_images_to_compare, titles):
                ...
                kp,descriptors = sift.detectAndCompute(all_images_to_compare_temp, None)
                #orb.detectAndCompute(all_images_to_compare_temp, None)
    ...
    def queryImage(self, query_path):
        ...
        orb = cv2.ORB_create()
        sift = cv2.xfeatures2d.SIFT_create()
        kp, descriptors = sift.d.etectAndCompute(query_image, None)
...
print('***************sift Method******************')
desc_path="Descriptor_sift/"
path="Images/*.jpg"
index_path = "index_sift.csv"
